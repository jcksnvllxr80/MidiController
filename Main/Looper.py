...
GPIO.add_event_detect(ENCODE_A, GPIO.FALLING, callback=my_encoder_callback, bouncetime=5)
GPIO.add_event_detect(ENCODE_B, GPIO.FALLING, callback=my_encoder_callback, bouncetime=5)

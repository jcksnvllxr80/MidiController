...
class Rotary_Encoder(RgbKnob):
	...
	def show_midi_pedals(self):
		...
		if self.midi_pedal_menu.menu_data_position is None:
	...
	def show_midi_pedal_configuration_groups(self):
		...
		if self.midi_pedal_config_menu[midi_pedal_name].menu_data_position is None:
	...
	def show_midi_pedal_config_group_opts(self):
		...
		if current_midi_pedal_config_opt_menu.menu_data_position is None:
	...
	def show_midi_pedal_config_group_opt_details(self):
		...
		if self.menu.current_node.menu_data_position is None:
	...
	def execute_midi_pedal_opt(self):
		...
		current_midi_pedal_option_dict = self.midi_pedal_config_menu[midi_pedal_name].menu_data_dict.get(midi_pedal_conf_group_name, None)
	...
	def set_song_info_message(self):
		...
		logger.info("Now displaying indices song: " + str(self.displayed_song_index) + "; part: " + str(self.displayed_part_index))

...
# 		self.set_message(self.current_song.data.bpm)
	...
	def load_song_func(self):
		self.current_song = self.setlist.songs.index_to_node(self.songs_menu.menu_data_position)
	...
	def load_part_func(self):
		self.current_part = self.current_song.data.parts.index_to_node(self.parts_menu.menu_data_position)
